...
#     torch.load(checkpoints_dir + "efficientnet_se_tuned_classifer.pt")
# )
# eval_model(
#     model, offsite_test
# )  # , report_dir="task3/efficientnet_wbce_report_classifier_tuning.txt")
...
# eval_model(
#     model, offsite_test, report_dir="task3/efficientnet_se_report_full_tuning.txt"
# )
